...
export const KisanActionVerdict: React.FC = () => {
  ...
  return (
    <div className="bg-white border border-[#e3e8ee] rounded-3xl p-6 sm:p-7 shadow-sm space-y-5 transition-all">
      ...
      {/* AASRA 4-Model ML Pipeline Link */}
      <div className="mt-4 pt-3 border-t border-[#e3e8ee] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
